...
- [Terraform Namecheap Provider](https://registry.terraform.io/providers/namecheap/namecheap)
- [DNS Best Practices](https://www.namecheap.com/support/knowledgebase/article.aspx/319/2237/how-can-i-set-up-an-a-address-record-for-my-domain)

## Next Steps

<Cards>
  <Card title="Getting Started" href="/docs/getting-started" description="Learn the basics" />
  <Card title="Architecture" href="/docs/architecture" description="Understand the bridge" />

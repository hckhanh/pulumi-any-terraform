...
```typescript
{ "ping", url: "192.168.1.1" }
```

**tcp** - TCP port check
```typescript
{ "tcp", url: "example.com", port: 443 }
```

**udp** - UDP port check
```typescript
{ "udp", url: "example.com", port: 53 }
```
...
```typescript
{ "smtp", url: "mail.example.com", port: 587 }
```

**pop** - POP3 server check
```typescript
{ "pop", url: "mail.example.com", port: 110 }
```

**imap** - IMAP server check
```typescript
{ "imap", url: "mail.example.com", port: 993 }
```

...
| Survey | Project-scoped surveys with targeting and appearance configuration |
| ProxyRecord | Organization-scoped reverse proxy records for ingestion |
| ExternalDataSource | External data warehouse / data lake connections |

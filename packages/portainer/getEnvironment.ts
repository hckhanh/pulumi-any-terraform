...
export function getEnvironment(args: GetEnvironmentArgs, opts?: pulumi.InvokeOptions): Promise<GetEnvironmentResult> {
    ...
    return pulumi.runtime.invoke("portainer:index/getEnvironment:getEnvironment", {
        "id": args.id,
        "name": args.name,
...
export function getEnvironmentOutput(args: GetEnvironmentOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEnvironmentResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("portainer:index/getEnvironment:getEnvironment", {
        "id": args.id,
        "name": args.name,
    }, opts, utilities.getPackage());
}

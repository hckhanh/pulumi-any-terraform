...
/**
 * The provider type for the openfga package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'openfga';
     ...
     */
    declare public readonly apiAudience: pulumi.Output<string | undefined>;
    /**
     * Scopes for client credentials authentication. This can also be sourced from the `FGA_API_SCOPES` environment variable.
     */
    declare public readonly apiScopes: pulumi.Output<string | undefined>;
    /**
     ...
     */
    declare public readonly apiTokenIssuer: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            resourceInputs["apiAudience"] = args?.apiAudience;
            resourceInputs["apiScopes"] = args?.apiScopes;
            resourceInputs["apiToken"] = args?.apiToken;
            resourceInputs["apiTokenIssuer"] = args?.apiTokenIssuer;
    ...
    terraformConfig(): pulumi.Output<{[key: string]: any}> {
        const result: pulumi.Output<Provider.TerraformConfigResult> = pulumi.runtime.call("pulumi:providers:openfga/terraformConfig", {
            "__self__": this,

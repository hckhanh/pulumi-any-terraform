...
export async function getPackage() : Promise<string | undefined> {
	if (_packageRef === undefined) {
		...
		if (_packageRef === undefined) {
			...
			params.setName("openfga");
			params.setVersion("0.5.1");
			params.setValue(Uint8Array.from(atob("eyJyZW1vdGUiOnsidXJsIjoicmVnaXN0cnkub3BlbnRvZnUub3JnL29wZW5mZ2Evb3BlbmZnYSIsInZlcnNpb24iOiIwLjUuMSJ9fQ=="), c => c.charCodeAt(0)));

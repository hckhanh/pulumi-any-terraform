...
export class SecretSyncGithub extends pulumi.CustomResource {
     ...
     */
    public readonly destinationConfig!: pulumi.Output<outputs.SecretSyncGithubDestinationConfig>;
    /**
     ...
     */
    public readonly syncOptions!: pulumi.Output<outputs.SecretSyncGithubSyncOptions>;

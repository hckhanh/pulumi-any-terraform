...
export class SecretRotationPostgresCredentials extends pulumi.CustomResource {
     ...
     */
    public readonly parameters!: pulumi.Output<outputs.SecretRotationPostgresCredentialsParameters>;
    /**
     ...
     */
    public readonly rotateAtUtc!: pulumi.Output<outputs.SecretRotationPostgresCredentialsRotateAtUtc>;
    /**
     ...
     */
    public readonly secretsMapping!: pulumi.Output<outputs.SecretRotationPostgresCredentialsSecretsMapping>;

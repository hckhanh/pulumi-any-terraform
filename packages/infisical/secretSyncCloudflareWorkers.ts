...
export class SecretSyncCloudflareWorkers extends pulumi.CustomResource {
     ...
     */
    public readonly destinationConfig!: pulumi.Output<outputs.SecretSyncCloudflareWorkersDestinationConfig>;
    /**
     ...
     */
    public readonly syncOptions!: pulumi.Output<outputs.SecretSyncCloudflareWorkersSyncOptions>;

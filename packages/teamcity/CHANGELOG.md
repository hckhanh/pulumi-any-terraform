...
Update pulumi-teamcity from 0.0.95 to 0.0.96

**Full Changelog**: https://github.com/JetBrains/terraform-provider-teamcity/compare/v0.0.95...v0.0.96

## 0.2.2

### Patch Changes

Update pulumi-teamcity from 0.0.94 to 0.0.95

**Full Changelog**: https://github.com/JetBrains/terraform-provider-teamcity/compare/v0.0.94...v0.0.95
...
Update pulumi-teamcity from 0.0.92 to 0.0.93

**Full Changelog**: https://github.com/JetBrains/terraform-provider-teamcity/compare/v0.0.92...v0.0.93

Update pulumi-teamcity from 0.0.93 to 0.0.94

**Full Changelog**: https://github.com/JetBrains/terraform-provider-teamcity/compare/v0.0.93...v0.0.94

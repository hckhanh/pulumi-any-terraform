...
export function getSlackIntegrationOutput(args: GetSlackIntegrationOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSlackIntegrationResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("better-uptime:index/getSlackIntegration:getSlackIntegration", {
        "slackChannelName": args.slackChannelName,
    }, opts, utilities.getPackage());
}

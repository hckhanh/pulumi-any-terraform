...
export function getIpListOutput(args?: GetIpListOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIpListResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("better-uptime:index/getIpList:getIpList", {
        "filterClusters": args.filterClusters,
    }, opts, utilities.getPackage());
}

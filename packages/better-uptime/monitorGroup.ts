...
export class MonitorGroup extends pulumi.CustomResource {
    ...
    /**
     * Set<span pulumi-lang-nodejs=" sortIndex " pulumi-lang-dotnet=" SortIndex " pulumi-lang-go=" sortIndex " pulumi-lang-python=" sort_index " pulumi-lang-yaml=" sortIndex " pulumi-lang-java=" sortIndex " pulumi-lang-hcl=" sort_index "> sortIndex </span>to specify how to sort your monitor groups.
     */

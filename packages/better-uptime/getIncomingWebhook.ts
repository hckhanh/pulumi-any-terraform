...
export function getIncomingWebhookOutput(args: GetIncomingWebhookOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetIncomingWebhookResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("better-uptime:index/getIncomingWebhook:getIncomingWebhook", {
        "name": args.name,
    }, opts, utilities.getPackage());
}

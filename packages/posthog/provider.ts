...
/**
 * The provider type for the posthog package. By default, resources use package-wide configuration
...
export class Provider extends pulumi.ProviderResource {
    /** @internal */
    public static readonly __pulumiType = 'posthog';
    ...
    terraformConfig(): pulumi.Output<{[key: string]: any}> {
        const result: pulumi.Output<Provider.TerraformConfigResult> = pulumi.runtime.call("pulumi:providers:posthog/terraformConfig", {
            "__self__": this,

...
export { GetOrganizationMembersResult } from "./getOrganizationMembers";
...
export { GetOrganizationRuleArgs, GetOrganizationRuleResult, GetOrganizationRuleOutputArgs } from "./getOrganizationRule";
export const getOrganizationRule: typeof import("./getOrganizationRule").getOrganizationRule = null as any;
export const getOrganizationRuleOutput: typeof import("./getOrganizationRule").getOrganizationRuleOutput = null as any;
utilities.lazyLoad(exports, ["getOrganizationRule","getOrganizationRuleOutput"], () => require("./getOrganizationRule"));
...
export const OrganizationRule: typeof import("./organizationRule").OrganizationRule = null as any;
utilities.lazyLoad(exports, ["OrganizationRule"], () => require("./organizationRule"));
...
export { PipelineWebhookArgs, PipelineWebhookState } from "./pipelineWebhook";
export type PipelineWebhook = import("./pipelineWebhook").PipelineWebhook;
export const PipelineWebhook: typeof import("./pipelineWebhook").PipelineWebhook = null as any;
utilities.lazyLoad(exports, ["PipelineWebhook"], () => require("./pipelineWebhook"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "buildkite:index/clusterMaintainer:ClusterMaintainer":
            ...
            case "buildkite:index/pipelineWebhook:PipelineWebhook":
                return new PipelineWebhook(name, <any>undefined, { urn })
            case "buildkite:index/portal:Portal":
                return new Portal(name, <any>undefined, { urn })
            case "buildkite:index/registry:Registry":
...
pulumi.runtime.registerResourceModule("buildkite", "index/pipelineWebhook", _module)
pulumi.runtime.registerResourceModule("buildkite", "index/portal", _module)
